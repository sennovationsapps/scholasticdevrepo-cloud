...
playauthenticate.password.verify_signup.subject=Scholastic Challenge: Zakończ rejestrację
playauthenticate.password.verify_email.subject=Scholastic Challenge: Potwierdź adres e-mail
playauthenticate.password.reset_email.subject=Scholastic Challenge: Jak ustalić nowe hasło
...
playauthenticate.verify.email.requirement=Musisz potwierdzić swój adres e-mail, aby korzytać z Scholastic Challenge
...
playauthenticate.oauth.access.denied.explanation=Jeśli chcesz używać Scholastic Challenge za pomocą OAuth, musisz zaakceptować połączenie.
...
playauthenticate.index.title=Witaj w Scholastic Challenge
playauthenticate.index.intro=Przykład Scholastic Challenge
playauthenticate.index.intro_2=Oto szablon prostej aplikacji wykorzystującej Scholastic Challenge.
