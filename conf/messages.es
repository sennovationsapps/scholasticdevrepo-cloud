...
playauthenticate.password.verify_signup.subject=Scholastic Challenge: Complete su registro
playauthenticate.password.verify_email.subject=Scholastic Challenge: Confirme su dirección de email
playauthenticate.password.reset_email.subject=Scholastic Challenge: Cómo restablecer su contraseña
...
playauthenticate.verify.email.requirement=Antes de usar Scholastic Challenge, debe validar su email.
...
playauthenticate.oauth.access.denied.explanation=Si quiere usar Scholastic Challenge con OAuth, debe aceptar la conexión.
...
playauthenticate.index.title=Bienvenido Scholastic Challenge
playauthenticate.index.intro=Aplicación de ejemplo de Scholastic Challenge
